...
{
	Solid * pSolid = new Solid("D:/DownLoad/Compressed/CsgTest/BoolOpreator/trunk/box.txt", *m_Palette[m_nPaletteIndex], 0,0,0);
...
{
	Solid * pSolid = new Solid("D:/DownLoad/Compressed/CsgTest/BoolOpreator/trunk/sphere.txt", *m_Palette[m_nPaletteIndex], 0,0,0);
...
{
	Solid * pSolid = new Solid("D:/DownLoad/Compressed/CsgTest/BoolOpreator/trunk/cone.txt", *m_Palette[m_nPaletteIndex], 0,0,0);
...
{
	Solid * pSolid = new Solid("D:/DownLoad/Compressed/CsgTest/BoolOpreator/trunk/cylinder.txt", *m_Palette[m_nPaletteIndex], 0,0,0);
